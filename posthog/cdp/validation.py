...
def compile_hog(
    hog: str, supported_functions: Optional[set[str]] = None, keep_last_scope_open: Optional[bool] = True
) -> list[Any]:
    ...
    try:
        ...
        return create_bytecode(
            program,
            supported_functions=supported_functions or {"fetch", "postHogCapture"},
            keep_last_scope_open=keep_last_scope_open,
        ).bytecode
    except Exception as e:
